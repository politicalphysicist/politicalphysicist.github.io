...
shift away from fossil fuels. Instead, AOC proposes government
planning and investment to achieve a rapid change in our energy
system, while providing employment for everyone willing and able to
take it. As big and important a step as this is, however, we must
quickly begin developing detailed proposals and demands if it is to be
...
greenhouse gases we will allow. We then need to consider what these
emissions will be used to achieve and when they will be made. This
...
building massive amounts of new infrastructure and much of this will be
made from steel and concrete. Producing these materials emits CO~2~
due to the chemical reactions involved. Thus, in order to protect the
Global South from existing climate change we will inevitably have to
make climate change a little bit worse. That is not even to consider
the massive amounts of non-climate infrastructure needed in developing
countries, such as hospitals, decent housing, and reliable electricity.
...
However, when it comes to deciding how to achieve these goals and
...
probably representatives of industry.[^0] The goal would be to bring
...
To develop such a plan it will be useful to have some idea of what a
(net) zero carbon society will like. For example, how much energy will
...
exploiting loopholes? One approach could be allying the NDC with the
workers in key companies. The latter should be legally empowered to
take measures up to and including strike action to keep their employer
in line.

I would argue that energy and transport are both of such importance to
decarbonisation that even this would not be sufficient,
...
with regards to energy). As such, both will need to be nationalised in
...
councils should develop their own decarbonisation plans. Key
areas to be addressed would likely be transport and housing. The
former would involve reducing car use in urban
areas, perhaps including an outright ban on personal vehicles in city
centres (where feasible). This would require a dramatic increase in
public transit provision. Further planning would be needed to
electrify public transit, taxis, service vehicles, and remaining
cars. Any socialist government should instigate a new wave of
[council house construction](https://newsocialist.org.uk/a-socialist-housing-policy/),
which provides an opportunity to drastically improve energy efficiency in
homes. Furthermore, these should be multi-use developments which are
pedestrian-friendly and reduce the need for car ownership. Climate
change must also be taken into account in the [planning
system](https://newsocialist.org.uk/labour-and-planning-system-lessons-fracking/):
no project should be given planning permission unless it is shown to
be compatible with local and national decarbonisation goals. Finally,
as the level of government closest to individual citizens, local
authorities would be well placed to carry out education and
consultations on behalf of the NDC.
...
to improve upon it where possible.

The rule of thumb for addressing climate change is to "electrify
everything and clean up the grid". For example, we can address emissions from
gas boilers by switching to heat pumps powered by clean
...
so. However, there are a few
sources of emissions for which this approach is not applicable either
because energy consumption is not what produces the GHGs or
because it would not be possible to switch the energy supply to
electricity. In these cases, we need to prioritise the development and
commercialisation of new technologies without such limitations. Key
areas of research would thus be

- finding a carbon-neutral liquid fuel for aviation, shipping, and
  long-distance road transport
- developing a way to smelt steel without using coal
- producing cement without emitting CO~2~
...
research (up to and including the point of commercialisation) with the
...
can not expect it to be so enlightened in this instance. Despite
...
themselves to the dictates of a government plan (let alone a popular
and democratic one).

There are no easy answers to this. Subjecting capital to democratic
planning will require an enormously powerful working class movement
able to scare it into acquiescence and there are no signs that
this will be available any time soon. As such, doom-mongering about
the need to fix climate change by 2030 (or whatever is the latest
cutoff date) is not useful; there is every chance that, despite our
best efforts as activists, we will not be strong enough soon enough to
meet that deadline. In this context, setting relatively short-term
hard deadlines could easily cause people to give up in despair or
...
of decarbonisation like I described above it may already be too late
...
implemented. Unions can not expect to make this happen simply by
...
workers. Tactics which fail to do this, such as gluing ourselves to
trains, are a level of self indulgence which we can not afford.
...
for the moment we will likely need to at least hear the opinion of
management.
